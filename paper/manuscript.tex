...
\end{eqnarray*}
%
Using H\"older's inequality and \eref{eq:PDE_advection}, this simplifies to a observation originally noted by Poon \cite{Chi-Cheu1996}:
%
\begin{eqnarray}
	\ddt{} \pbrac{ \frac{\hone{\theta}^2}{\ltwo{\theta}^2} } 
...
\begin{figure}
\centering
\includegraphics[width=1.0\textwidth]{images/enstrophy_rate}
