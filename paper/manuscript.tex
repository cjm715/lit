...
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{scale-and-intensity}
...
\begin{figure}
\includegraphics[]{enstrophy_film}
\caption{Local-in-time optimisation with enstrophy constraint. Top filmstrip is for $Pe =\infty$ and the bottom filmstrip is $Pe=2048$. Note that the grey-scale for the $Pe=\infty$ is constant in time while it is adjusted to show the tracer concentration structure in the finite $Pe$ case. }
\label{fig:enstrophy_film}
\end{figure}
%
\begin{figure}
\includegraphics[]{energy_film}
...
%
\begin{figure}
\includegraphics[]{enstrophy_length}
...
\begin{figure}
\centering
\includegraphics[]{enstrophy_rate}
