...
The $H^{-1}$ norm or mix-norm \cite{GM2005} is a common measure of mixing used throughout the literature and will be used here. The $H^{-1}$ norm is given by  
%
\begin{equation}
